...
Instagram image downloader is a Userscript to download Instagram images.
...
If you installed one of the extensions, you can install the script from [OpenUserJS](https://openuserjs.org/scripts/lbreda/Instagram_image_downloader)
